...
public abstract class DyeableArmorEffect {
    ...
    protected Stream<ItemStack> getMatchingEquippedArmor(LivingEntity entity, ExtendedArmorMaterial material) {
        return armorEquipmentSlots.stream()
                ...
                .filter(stack -> stack.getItem() instanceof DyeableExtendedArmorItem && ((DyeableExtendedArmorItem)stack.getItem()).getMaterial() == material);
    }

    protected Stream<ItemStack> getMatchingEquippedArmor(LivingEntity entity, ItemStack stack) {
        return getMatchingEquippedArmor(entity, ((DyeableExtendedArmorItem)stack.getItem()).getMaterial());
    }
