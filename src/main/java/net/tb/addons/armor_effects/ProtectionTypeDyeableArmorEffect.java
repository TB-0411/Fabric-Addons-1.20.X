...
public class ProtectionTypeDyeableArmorEffect extends DyeableArmorEffect {
    private final float strength;
    private final RegistryKey<DamageType> type;
    private final String typeName;

    public ProtectionTypeDyeableArmorEffect(float strength, RegistryKey<DamageType> type, String typeName) {
